...
@register_model
def beit3_base_patch16_384_vqav2_aug(pretrained=False, **kwargs):
    args = _get_base_config(img_size=384, **kwargs)
    args.normalize_output = False
    model = BEiT3ForVisualQuestionAnswering(args, num_classes=4501, **kwargs)
    return model

@register_model
def beit3_base_patch16_480_vqav2_aug(pretrained=False, **kwargs):
    args = _get_base_config(img_size=480, **kwargs)
    args.normalize_output = False
    model = BEiT3ForVisualQuestionAnswering(args, num_classes=4501, **kwargs)
    return model
...
@register_model
def beit3_large_patch16_384_vqav2_aug(pretrained=False, **kwargs):
    args = _get_large_config(img_size=384, **kwargs)
    args.normalize_output = False
    model = BEiT3ForVisualQuestionAnswering(args, num_classes=4501, **kwargs)
    return model
...
@register_model
def beit3_large_patch16_480_vqav2_aug(pretrained=False, **kwargs):
    args = _get_large_config(img_size=480, **kwargs) 
    args.normalize_output = False
    model = BEiT3ForVisualQuestionAnswering(args, num_classes=4501, **kwargs)
    return model
...
@register_model
def beit3_large_patch16_768_vqav2_aug(pretrained=False, **kwargs):
    args = _get_large_config(img_size=768, **kwargs)
    args.normalize_output = False
    model = BEiT3ForVisualQuestionAnswering(args, num_classes=4501, **kwargs)
    return model
...
@register_model
def beit3_base_patch16_384_vqav2_flip(pretrained=False, **kwargs):
    args = _get_base_config(img_size=384, **kwargs)
    args.normalize_output = False
    model = BEiT3ForVisualQuestionAnswering(args, num_classes=3128, **kwargs)
    return model


@register_model
def beit3_base_patch16_480_vqav2_flip(pretrained=False, **kwargs):
    args = _get_base_config(img_size=480, **kwargs)
    args.normalize_output = False
    model = BEiT3ForVisualQuestionAnswering(args, num_classes=3128, **kwargs)
    return model
...
@register_model
def beit3_large_patch16_384_vqav2_flip(pretrained=False, **kwargs):
    args = _get_large_config(img_size=384, **kwargs)
    args.normalize_output = False
    model = BEiT3ForVisualQuestionAnswering(args, num_classes=3128, **kwargs)
    return model
...
@register_model
def beit3_large_patch16_480_vqav2_flip(pretrained=False, **kwargs):
    args = _get_large_config(img_size=480, **kwargs)
    args.normalize_output = False
    model = BEiT3ForVisualQuestionAnswering(args, num_classes=3128, **kwargs)
    return model
...
@register_model
def beit3_large_patch16_768_vqav2_flip(pretrained=False, **kwargs):
    args = _get_large_config(img_size=768, **kwargs)
    args.normalize_output = False
    model = BEiT3ForVisualQuestionAnswering(args, num_classes=3128, **kwargs)
    return model
